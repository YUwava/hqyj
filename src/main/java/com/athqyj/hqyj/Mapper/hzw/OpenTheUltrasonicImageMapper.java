...
public interface OpenTheUltrasonicImageMapper {
    ...
    @Select("select * from m_info where ID='1017062000005'")
    ...
    @Select("select * from b_chaoimage where ID='1017062000005'")
    ...
    @Select("select * from nv_bchao where ID='1017062000005'")
